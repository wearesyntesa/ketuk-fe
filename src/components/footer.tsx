      ...
      <div className="container mx-auto px-6 lg:px-8 relative z-10">
        <div className="flex flex-col md:flex-row justify-between items-center gap-8 mb-20 pb-12 border-b border-slate-200">
          <div className="max-w-xl">
            <h2 className="text-3xl font-bold tracking-tight text-slate-900 mb-2">{t("readyToModernize")}</h2>
            <p className="text-slate-500 text-lg">{t("joinUniversities")}</p>
          </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-12 gap-8 lg:gap-12 mb-16">
          <div className="col-span-2 md:col-span-4 lg:col-span-5 flex flex-col gap-6 pr-8">
            <Link href="/" className="flex items-center gap-2 group w-fit">
              ...
              <span className="text-xl font-bold tracking-tight text-slate-900">{tCommon("appName")}</span>
            </Link>
            ...
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white border border-slate-200 shadow-sm w-fit">
              ...
              <span className="text-xs font-semibold text-slate-600">{t("allSystemsOperational")}</span>
            </div>
          </div>

          <div className="col-span-1 md:col-span-2 lg:col-span-2">
            <h3 className="text-sm font-bold text-slate-900 tracking-wide mb-4">{t("service")}</h3>
          ...
          <div className="col-span-1 md:col-span-2 lg:col-span-2">
            <h3 className="text-sm font-bold text-slate-900 tracking-wide mb-4">{t("connect")}</h3>
            <ul className="space-y-3 text-sm">
              <li>
                <Link
          ...
          <div className="col-span-2 md:col-span-4 lg:col-span-3">
            <h3 className="text-sm font-bold text-slate-900 tracking-wide mb-4">{t("contact")}</h3>
            <ul className="space-y-3 text-sm">
              <li>
                <Link
        ...
        <div className="pt-8 border-t border-slate-200 flex flex-col-reverse md:flex-row justify-between items-center gap-4 text-xs text-slate-500 font-medium">
          <p>© 2024 Ketuk Inc. {t("allRightsReserved")}</p>
