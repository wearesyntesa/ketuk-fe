    ...
    <div className="flex flex-col gap-3">
      {dayEvents.length === 0 ? (
        <div className="flex h-24 items-center justify-center rounded-2xl border border-dashed border-slate-200 bg-slate-50/50 p-4">
          <p className="text-sm font-medium text-slate-400 italic">No events on {day}</p>
        </div>
      ) : (
              ...
              <DialogHeader className="space-y-4">
                <div className="flex items-center gap-3 pb-2 border-b border-slate-100">
                  ...
                  <div>
                    ...
                    <p className="text-xs font-bold uppercase tracking-wider text-slate-400 mt-0.5">Event Details</p>
                  </div>
                </div>
                ...
                <div className="space-y-4 pt-2">
                  <div className="grid gap-3">
                    <div className="flex items-start gap-3 p-3 rounded-xl bg-slate-50/80">
                      ...
                      <div>
                        <p className="text-xs font-semibold uppercase text-slate-400">Organizer</p>
                  ...
                  <div className="pt-2">
                    <p className="text-xs font-semibold uppercase text-slate-400 mb-2">Description</p>
